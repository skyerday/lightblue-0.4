...
if MAC:
    if "install" in sys.argv:
        ...
        os.system("xcodebuild install -arch 'i386' -arch 'x86_64' -target LightAquaBlue -configuration Release DSTROOT=/ INSTALL_PATH=/Library/Frameworks DEPLOYMENT_LOCATION=YES")
